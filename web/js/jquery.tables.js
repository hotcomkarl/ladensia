(function($){
    $.paginate = function(el, options) {
        ...
        base.init = function(){
            ...
            $('<li class="first"><a class="'+base.options.buttonClass+'" href="#">Erste</a></li>').click(function(){
            ...
            $('<li class="last"><a class="'+base.options.buttonClass+'" href="#">Letzte</a></li>').click(function(){
